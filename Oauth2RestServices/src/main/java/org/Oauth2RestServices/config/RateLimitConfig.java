...
import org.Oauth2RestServices.intercepter.RateLimitInterceptor;
...
public class RateLimitConfig implements WebMvcConfigurer {
	  ...
	  public void addInterceptors(InterceptorRegistry registry) {
	    ...
	    registry.addInterceptor(new RateLimitInterceptor(bucket, 1)).addPathPatterns("/elearning");
	    ...
	    registry.addInterceptor(new RateLimitInterceptor(bucket, 1))
	        .addPathPatterns("/elearning/courses");
